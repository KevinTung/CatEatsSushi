...
//  SushiNeko
//
//  Created by Kevin Tung on 2016/8/3.
...
class GameScene: SKScene {
    ...
    override func didMoveToView(view: SKView) {
        ...
        scoreLable = childNodeWithName("scoreLabel") as! SKLabelNode
    ...
    override func touchesBegan(touches: Set<UITouch>, withEvent event: UIEvent?) {
        ...
        for touch in touches {
            ...
            let firstPiece = sushiTower[0] as SushiPiece!
    ...
    func addRandomPieces(total: Int) {
        ...
        for _ in 1...total {
            ...
            if lastPiece.side != .None {
                ...
                let rand =  CGFloat(Float(arc4random()))/CGFloat(UINT32_MAX)
                if rand < 0.45 {
